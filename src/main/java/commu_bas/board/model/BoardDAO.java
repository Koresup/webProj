...
public class BoardDAO {
	...
	public int totalCntSearch(String search) {
		...
		sql = "select count(*) from commu_bas_board where title like ? ";
	...
	public ArrayList<BoardDTO> list(int start, int limit, String field, String search) {
		...
		sql = "select * from commu_Bas_board " + "where " + field + " like ? order by reg_date desc limit ?, ? ";
	...
	public ArrayList<BoardDTO> list(int start, int limit, String search) {
		...
		sql = "select * from commu_Bas_board " + "where title like ? order by reg_date desc limit ?, ? ";
	...
	public ArrayList<BoardDTO> list(int start, int limit) {
		...
		sql = "select * from commu_Bas_board " + "order by reg_date desc limit ?, ? ";
