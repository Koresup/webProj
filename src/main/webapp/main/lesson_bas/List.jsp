	...
	<div id="lesson_bas_list">
		...
		<ul class="pagination justify-content-center">
			<c:if test="${pageStart > 1 }">
				<li class="page-item">
					<a class="page-link" href="<c:url value="/lesson_bas/List?page=${pageStart - 1 }&field=${param.field }&search=${param.search }"/>">이전</a>
				</li>
			</c:if>
			...
			<c:if test="${pageEnd<pageTotal }">
				<li class="page-item"><a class="page-link"
					href="<c:url value="/lesson_bas/List?page=${pageEnd + 1 }&field=${param.field }&search=${param.search }"/>">다음</a>
				</li>
			</c:if>
		</ul>
		<hr />
