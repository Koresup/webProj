...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <link rel="stylesheet" href="/proj_04_minsoo/main/css/lesson_bas_modify.css">
    <style>
        h2#main_title {
            margin: 20px;
        }
...
<input type="hidden" name="nowPage" value="${nowPage }" />
    ...
    <div id="main_wrap">
        <div>
            <h2 id="main_title">농구 레슨 글 수정</h2>
        </div>
        <hr>
        <div id="lesson_bas_detail">
                ...
                <tr>
                    ...
                    <td>
                        <div id="info_detail">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sname" value="${dto.sname }" />
                            </div>
                            <hr>
                            <!-- 옵션 이미지 -->
                    ...
                    <td colspan="2">
                        <div id="lesson_info">
                            <div class="detail_list">
                                ...
                                <input type="text" class="form-control" id="title" name="price" value="${dto.lesson_time }"/>
                            </div>
                            <div class="detail_list">
                                <dt class="list_title">모집인원</dt>
                                <input type="text" class="form-control" id="title" name="price" value="${dto.max_student }"/>
                            </div>
                            <div class="detail_list">
                                <dt class="list_title">비용</dt>
                                <input type="text" class="form-control" id="title" name="price" value="${dto.price }"/>
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <div id="lesson_bottom">
                <div class="outter">
                    <div class="bottom_name location">[주소]</div>
                    <div>
                        <p class="bottom_content">
	                        ...
	                        <p class="bottom_content">
							    ...
							    <input type="text" name="location" id="location" placeholder="주소" value="${dto.location }"><br><br />
                ...
                <div class="outter">
                    ...
                    <div><p class="bottom_content"> 
                        <textarea name="contents_info" cols="100" rows="10" style="resize:none;">${dto.contents_info }</textarea>
                       </p></div>
                </div>            
                <div class="outter">
                    <div class="bottom_name detail">[상세정보]</div>
                    <div class=""><p class="bottom_content">
                        <textarea name="contents_detail" cols="100" rows="10" style="resize:none;" >${dto.contents_detail }</textarea>
                    </p></div>
                </div>            
                <div class="outter">
                    <div class="bottom_name rule">[이용규칙]</div>
                    <div><p class="bottom_content">
                        <textarea name="contents_rule" cols="100" rows="10" style="resize:none;">${dto.contents_rule }</textarea>
                    </p></div>
                </div>            
                <div class="outter">
                    ...
                    <div>
                        <p class="bottom_content">
                            <textarea name="contents_refund" cols="100" rows="10" style="resize:none;">${dto.contents_refund }</textarea>
                        </p>
                    </div>
                </div>         
