...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
    ...
    <link rel="stylesheet" href="/proj_04_minsoo/main/css/lesson_bas_insert.css">
    <style>
        h2#main_title {
            margin: 20px;
        }
        ...
        <div id="lesson_bas_insert">
                ...
                <tr>
                    ...
                    <td>
                        <div id="info_insert">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sname" id="title" placeholder="레슨명을 입력하세요.">
                            </div>
                            <hr>
                            <!-- 옵션 이미지 -->
                    ...
                    <td colspan="2">
                        <div id="lesson_info">
                            <div class="detail_list">
                                ...
                                <input type="text" class="form-control" name="lesson_time" id="title" placeholder="예) 매주 화 15:00-17:00">
                            </div>
                            <div class="detail_list">
                                <dt class="list_title">모집인원</dt>
                                <input type="text" class="form-control" name="max_student" id="title" placeholder="예) 15">
                            </div>
                            <div class="detail_list">
                                <dt class="list_title">비용</dt>
                                <input type="text" class="form-control" name="price" id="title" placeholder="150000">
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <div id="lesson_bottom">
                <div class="outter">
                    ...
                    <div>
                        <p class="bottom_content">
						    ...
						    <input type="text" name="location" id="location" placeholder="주소" readonly><br><br />
                ...
                <div class="outter">
                    ...
                    <p class="bottom_content">
                        <textarea name="contents_detail" cols="100" rows="10" style="resize:none;" placeholder="상세정보를 입력하세요"></textarea>
                    </p>
                </div>
                <div class="outter">
                    ...
                    <p class="bottom_content">
                        <textarea name="contents_rule" cols="100" rows="10" style="resize:none;" placeholder="이용규칙을 입력하세요"></textarea>
                    </p>
                </div>
                <div class="outter">
                    ...
                    <p class="bottom_content">
                        <textarea name="contents_refund" cols="100" rows="10" style="resize:none;" placeholder="환불규정을 입력하세요"></textarea>
                    </p>
                </div>
