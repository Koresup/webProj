...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
    ...
    <link rel="stylesheet" href="/proj_04_minsoo/main/css/lesson_bas_detail.css">
    <style>
    ...
    <div id="main_wrap">
        ...
        <div id="lesson_bas_detail">
            <table id="lesson_top" class="table">
                <tr>
                    <td rowspan="3" id="img_area">
                        ...
                        <c:forTokens items ="${dto.img }" delims = "," var = "ee" varStatus="no">
							<img src="<c:url value="/uploadFile/lesson_bas/${ee}"/>" alt="" style="width: 150px; height: 150px;"/>
						</c:forTokens>
                        </div>
                    </td>
                ...
                <tr>
                    <td><div id="lesson_reservation"><a href=""><button>신청하기</button></a></div></td>
                </tr>
            </table>
            ...
            <div id="lesson_bottom">
                <div class="outter">
                    ...
                    <div>
                        <p class="bottom_content">- ${dto.location } <a href="https://map.kakao.com/link/to/33.919067,-118.118731" style="color:blue" target="_blank"><button>길찾기</button></a></p>
                    </div>
                    <div>
                ...
                <div class="outter">
                    <div class="bottom_name manager_id">[매니저]</div>
                    <div><p class="bottom_content">${dto.manager_id }</p></div>
                </div>            
                <div class="bottom_button">
                	<a href="<c:url value="/lesson_bas/List?page=${nowPage }"/>"><button>목록으로</button></a>
                    <a href="<c:url value="/lesson_bas/InsertForm?page=${nowPage }"/>"><button>새글쓰기</button></a>
                    <a href="<c:url value="/lesson_bas/ModifyForm?post_id=${dto.post_id }&page=${nowPage }"/>"><button>수정</button></a>
                    <a href="<c:url value="/lesson_bas/DeleteForm?post_id=${dto.post_id }&page=${nowPage }"/>"><button>삭제</button></a>
